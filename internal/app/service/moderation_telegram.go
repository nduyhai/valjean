...
type telegramModeration struct {
	config config.Telegram
}

func newTelegramModeration(config config.Telegram) moderationStrategy {
	return &telegramModeration{config: config}
}

func (m *telegramModeration) Allowed(_ context.Context, in entities.EvalInput) bool {
